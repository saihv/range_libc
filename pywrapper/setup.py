...
def check_for_flag(flag_str, truemsg=False, falsemsg=False):
    ...
    if enabled and not truemsg == False:
        ...
        print(falsemsg)
        print(f"   $ sudo {flag_str}=ON python setup.py install")
    return enabled
...
def customize_compiler_for_nvcc(self):
    ...
    If you subclass UnixCCompiler, it's not trivial to get your subclass injected in, and
    still have the right customizations (i.e. distutils.sysconfig.customize_compiler) run on
    it. So instead of going the OO route, I have this. Note, it's kindof like a wierd
    functional subclassing going on.
    """
